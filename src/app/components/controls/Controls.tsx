...
export const Controls = () => {
  ...
  const changeViewType = (_: MouseEvent<HTMLElement>, viewType: any) => {
    setViewType(viewType);
  };

  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const changeViewMode = (_: MouseEvent<HTMLElement>, newViewMode: any) => {
  ...
  return (
    <section className={classes.controls}>
      ...
      />
      <ToggleButtonGroup exclusive onChange={changeViewMode} size="small" value={viewMode}>
